...
then
	...
	split_libraries_fastq.py -i $fasta$ourRun -o ./split_libraries_fastq$rep --barcode_read_fps $fasta$ourindex --mapping_fps $mappingfile --phred_quality_threshold 19 --barcode_type 12
